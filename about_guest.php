  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-6 text-center">
        <a class="navbar-brand" href="index.html"><img src="images/test10.png" alt="" class="img-fluid w-100"></a>
      </div>
    </div>
  </div>
</div>
					...
					<div class="collapse navbar-collapse" id="navbarContent">
						<ul id="menu" class="menu navbar-nav ">
							<li class="nav-item dropdown  pl-0">
								<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onclick="window.location.href='guest.php';">
								 Beranda
								</a>
							</li>
							<li class="nav-item"><a href="about_guest.php" class="nav-link">Tentang</a></li>
                          	<li class="nav-item"><a href="fashion_guest.php" class="nav-link">Kategori</a></li>
                          	<li class="nav-item"><a href="contact_guest.php" class="nav-link">Kontak</a></li>
							</li>
...
<div class="row">
    <div class="col-lg-12">
        <img src="images/sky.png" alt="" class="img-fluid w-100">
    </div>
</div>
	...
	<div class="col-lg-12">
		<div class="row">
			<div class="col-lg-4">
				...
				<p>Saya sebenarnya dalang dari pembunuhan terkenal. Banyak yang mengira saya hanyalah legenda belaka.
                   Killcount cuma 1 tapi masih belum tertangkap,padahal targetnya VIP dan sangat berpengaruh terhadap
			...
			<div class="col-lg-4">
				...
				<p>Visi saya adalah memperbaiki kesalahan yang saya buat bertahun-tahun lalu. Meskipun tidak dapat ditebus,
                    saya tetap ingin meringankan dosa yang telah saya perbuat. Kalaupun saya ternyata kumat lagi, saya usahakan
                    agar klien tidak merasakan sakit.
                </p>
			</div>
			<div class="col-lg-4">
		...
		<h3 class="mb-3 mt-5">Tidak ada penyesalan</h3>
		<p class="mb-5">Penyesalan pasti datang di akhir. Tapi untuk menyesali suatu hal,perlu adanya perasaan bersalah yang dimana saya hampir tidak merasakan.</p>

		<div class="row">
			<div class="col-lg-3 col-md-6">
				<div class="about-widget mb-4 mb-lg-0 w-100">
					<img src="images/pfp1.jpg" alt="" class="img-fluid">
					<h4 class="mt-3">Hill Ward</h4>
				</div>
			</div>
			<div class="col-lg-3 col-md-6">
				<div class="about-widget mb-4 mb-lg-0">
					<img src="images/pfp7.jpg" alt="" class="img-fluid">
					<h4 class="mt-3">Oly</h4>
				</div>
			</div>
			<div class="col-lg-3 col-md-6">
				<div class="about-widget mb-4 mb-lg-0 w-100">
					<img src="images/pfp6.jpg" alt="" class="img-fluid">
					<h4 class="mt-3">Rey</h4>
				</div>
			</div>
			<div class="col-lg-3 col-md-6">
				<div class="about-widget mb-4 mb-lg-0 w-100">
					<img src="images/pfp4.png" alt="" class="img-fluid">
